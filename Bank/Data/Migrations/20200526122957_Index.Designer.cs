...
namespace Bank.Web.Data.Migrations
{
    ...
    [Migration("20200526122957_Index")]
    partial class Index
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bank.Web.Data.BankUser", b =>
                {
            ...
            modelBuilder.Entity("Bank.Web.Models.Accounts", b =>
                {
            ...
            modelBuilder.Entity("Bank.Web.Models.Cards", b =>
                {
            ...
            modelBuilder.Entity("Bank.Web.Models.Dispositions", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bank.Web.Models.PermenentOrder", b =>
                {
            ...
            modelBuilder.Entity("Bank.Web.Models.Transactions", b =>
                {
            ...
            modelBuilder.Entity("Bank.Web.Models.Cards", b =>
                {
                    b.HasOne("Bank.Web.Models.Dispositions", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("Bank.Web.Models.Dispositions", b =>
                {
                    b.HasOne("Bank.Web.Models.Accounts", "Account")
            ...
            modelBuilder.Entity("Bank.Web.Models.Transactions", b =>
                {
                    b.HasOne("Bank.Web.Models.Accounts", "AccountNavigation")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Bank.Web.Data.BankUser", null)
                        .WithMany()
